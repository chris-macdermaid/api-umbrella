{{#if this.session.isAuthenticated}}
  <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark px-3">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <ul class="navbar-nav me-auto">
        {{#if this.currentAdmin.permissions.analytics}}
          <li class="nav-item dropdown nav-analytics">
            <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{t "Analytics"}}</a>
        ...
        {{#if (or this.currentAdmin.permissions.user_view this.currentAdmin.permissions.admin_view)}}
          <li class="nav-item dropdown nav-users">
            <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{t "Users"}}</a>
            <div class="dropdown-menu">
        ...
        {{#if (or this.currentAdmin.permissions.backend_manage this.currentAdmin.permissions.backend_publish)}}
          <li class="nav-item dropdown nav-config">
            <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{t "Configuration"}}</a>
            <div class="dropdown-menu">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a href="#" id="nav_gear_menu" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><FaIcon @icon="cog" @fixedWidth={{true}} role="presentation" /></a>
