...
local db_setup_command = parser:command("db-setup")
  :description("Run the initial database setup task.")
  :action(_M.db_setup)
db_setup_command:flag("--reset")
  :description("Drop and recreate the database before setting up.")
